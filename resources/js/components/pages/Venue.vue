<template>
    <v-container>
        <div v-if="venue !== null" class="d-flex justify-center mb-4">
        ...
        <div>
            <v-card
                ...
                <!-- carousel -->
                <div v-if="venue.files">
                    <div v-if="venue.files !== null && venue.files.length > 0">
                        <v-carousel
                            cycle
                            interval="5000"
                            hide-delimiters
                        ...
                        >
                            <v-carousel-item
                                v-for="(file, index) in venue.files"
                                :key="index"
...
export default {
    ...
    methods: {
        ...
        editThis: function(id) {
            this.$router.push(
                `${this.baseURL}${this.$i18n.locale}/admin/venues/edit/${id}`
            );
        },
        deleteThis: function(id) {
            this.$router.push(
                `${this.baseURL}${this.$i18n.locale}/admin/venues/delete/${id}`
            );
        },
        ...
        gotoVenues() {
            this.$router.push(`${this.baseURL}${this.$i18n.locale}/venues`);
        },
        fetchAPI() {
            axios
                .request({
